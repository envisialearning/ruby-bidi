  ...
  class Algorithm
    ...
    class << self
      ...
      def run
        ...
        yield send(:new, idxFile, dataFile, mirrorFile)
      ensure
        idxFile.close rescue nil
        dataFile.close rescue nil
        mirrorFile.close rescue nil
      end
    end

    def initialize(idxFile, dataFile, mirrorFile)
      @@idx_record_len=7
      @idxFile = idxFile
      @dataFile = dataFile
